...
/// @title FlareQuorumAwardReceiptV2
...
contract FlareQuorumAwardReceiptV2 {
    struct Award {
        uint256 tenderId;
        uint256 winnerBidId;
        address buyer;
    ...
    string public constant name = "FlareQuorum Award Receipt V2";
    string public constant symbol = "FQAR2";
