        ...
        <article className="docs-content">
          ...
          <section id="recovery">
            ...
            <ul className="docs-checklist">
              ...
              <li>Current simulated tee-node startup generates a new identity after a process restart. Same-identity restore is not claimed until Flare provides an approved mechanism.</li>
          ...
          <section id="boundaries">
            ...
            <ul className="docs-checklist">
              ...
              <li>Same-identity TEE restart recovery, broader wallet coverage, and structured buyer/vendor validation remain open and are not presented as traction.</li>
            </ul>
            <div className="docs-actions">
