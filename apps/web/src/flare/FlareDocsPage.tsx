        ...
        <article className="docs-content">
          ...
          <section id="verification">
            ...
            <ul className="docs-checklist">
              ...
              <li><a className="text-link" href="https://github.com/huutrungle2001/flare-quorum/blob/main/submission/flarequorum/README.md" target="_blank" rel="noreferrer">Read the judge package ↗</a></li>
