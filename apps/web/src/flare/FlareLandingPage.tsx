...
const workspaces = [
  ...
  ["02", "BUYER", "Define one public tender, then choose Coston2/FTestXRP or the advanced XRPL/FDC/Smart Account funding path.", "/flare?role=buyer", "OPEN BUYER"],
  ...
  ["05", "AUDITOR", "Verify the public binding, commitments, result digest, payout, and remainder with no signer or reveal path.", "/flare?role=auditor", "OPEN AUDITOR"],
] as const;
    ...
    <div className="marketing-page flare-marketing-page">
      <main className="landing-main" id="main-content">
        ...
        <section className="landing-flow">
          ...
          <ol>
            <li><strong>01 / BUYER</strong><span>Build public rules and choose either direct Coston2/FTestXRP escrow or the supported XRP-native handoff.</span></li>
