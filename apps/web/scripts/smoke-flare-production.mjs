...
const assertions = {
  ...
  verifiedReleaseRendered: desktop.dom.includes("VERIFIED V2 RELEASE") && mobile.dom.includes("VERIFIED COSTON2 RELEASE"),
  walletFreeTenderListLoaded: tenderRoom.dom.includes("COSTON2 DOSSIERS") && mobile.dom.includes("COSTON2 DOSSIERS"),
  productStoryRendered: desktop.dom.includes("Private bids.") && desktop.dom.includes("Public awards.") && desktop.dom.includes("04 / COMPUTE"),
