...
const evidencePath = resolve(
  root,
  process.env.FLAREQUORUM_FUNDING_CHECKPOINT_EVIDENCE ?? "evidence/coston2/web-xrp-funding-checkpoint.json",
);
...
const profile = mkdtempSync(join(tmpdir(), "flare-quorum-funding-checkpoint-"));
const stderr = { value: "" };
