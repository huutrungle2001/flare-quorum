...
const evidencePath = resolve(
  root,
  process.env.FLAREQUORUM_XRP_DRAFT_EVIDENCE ?? process.env.VEILBID_FLARE_XRP_DRAFT_EVIDENCE ?? "evidence/coston2/web-xrp-funding-draft.json",
);
...
const profile = mkdtempSync(join(tmpdir(), "veilbid-flare-xrp-draft-"));
const stderr = { value: "" };
