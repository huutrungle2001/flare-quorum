# FlareQuorum — 60-second privacy and trust explanation

FlareQuorum makes the procurement rule and the outcome public while keeping the
...
the XRP-native funding path; FlareQuorum never receives an XRPL secret. This is
